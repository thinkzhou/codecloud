...
'js/ui/v253.js',
'tests/regression.js','tests/time-regression-0275.js','tests/gift-regression.js','tests/supply-regression.js','tests/supply-relation-regression.js','tests/supply-entry-regression.js','tests/produce-regression.js','tests/survival-regression.js','tests/v278-regression.js','tests/v280-regression.js'
].forEach(load);
